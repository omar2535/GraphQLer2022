...
class FunctionBuilder:
    ...
    def __init__(self, schema_json_file_path, function_list_file_path = None, query_parameter_file_path = None, mutation_parameter_file_path = None, no_scalar_datatype_mapping = False):
        """
        Parameters
        ----------
        schema_json_file_path: the processed schema json file to be imported. This is mandatory.
        ...
        self.no_scalar_datatype_mapping = no_scalar_datatype_mapping
